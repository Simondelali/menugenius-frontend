...
export default function Flow() {
  ...
  const renderMenuOptions = (options, parentId = null, level = 0) => {
    return options
      ...
      .map(option => (
        <div key={option.id} className={`mb-4 ${level > 0 ? 'ml-2 sm:ml-6' : ''}`}>
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="bg-white shadow-md rounded-lg p-4 sm:p-6 mb-6 mt-20 sm:mt-24 w-full">
  <h2 className="text-lg sm:text-xl font-semibold mb-4">Add New Option</h2>
  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0 sm:space-x-4">
    ...
    <div className="flex items-center justify-between sm:justify-end space-x-4">
      ...
      <button
        ...
        className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded transition duration-300 w-full sm:w-auto"
      >
        Add Option
      </button>
    </div>
      ...
      {editingOption && (
        <div className="bg-yellow-50 shadow-md rounded-lg p-4 sm:p-6 mb-6">
          <h2 className="text-lg sm:text-xl font-semibold mb-4">Edit Option</h2>
      ...
      <div>
        <h2 className="text-xl sm:text-2xl font-semibold mb-4">Menu Flow</h2>
